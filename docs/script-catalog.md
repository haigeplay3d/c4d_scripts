...
| --- | --- | --- | --- | --- |
| 001 | 对象与场景 | [对象名称注释](../c4d_scripts/AnnotationFromName/README.md) | `AnnotationFromName.py` | 源码盘点；本轮未运行 |
| 002 | 对象与场景 | [删除空对象并保留子级](../c4d_scripts/DeleteNulls/README.md) | `DeleteNulls.py` | C4D 2025.3.3 批次宿主用例通过 |
| 003 | 对象与场景 | [对象与标签随层着色](../c4d_scripts/TagsSameColor/README.md) | `TagsSameColor.py` | 源码盘点；本轮未运行 |
| 004 | 坐标与尺寸 | [复制世界变换](../c4d_scripts/PositionWorldFollow/README.md) | `PositionWorldFollow.py` | 源码盘点；本轮未运行 |
| 005 | 坐标与尺寸 | [按目标尺寸等比缩放](../c4d_scripts/FigureScale/README.md) | `FigureScale.py` | C4D 2025.3.3 批次宿主用例通过 |
| 006 | 坐标与尺寸 | [坐标与角度取整](../c4d_scripts/RoundXYZ/README.md) | `RoundXYZ.py` | C4D 2025.3.3 批次宿主用例通过 |
